...
#+name: minimal_emacs
#+begin_src bash
emacs -Q --eval "(progn (require 'profiler) (profiler-start 'cpu) (require 'org) (require 'ob-python) (require 'ob-shell) (org-babel-do-load-languages 'org-babel-load-languages '((python . t) (shell . t))) (find-file \"blocks.org\") (setq org-confirm-babel-evaluate nil) (org-babel-execute-buffer) (profiler-report) (profiler-report-write-profile \"profile-report.txt\"))"
#+end_src
